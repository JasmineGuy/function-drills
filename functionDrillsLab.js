...
const nameGreeting =nameCheck("Hank")
...
function numberOfFrogs(amount) {
  return amount / 3
}
const totalFrogs =numberOfFrogs(99)
...
function numberOfFrogs2(amount) {
  return Math.floor(amount / 3)
}
const totalFrogs2 =numberOfFrogs2(4)
